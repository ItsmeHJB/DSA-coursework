...
--
-- Host: localhost
-- Generation Time: Mar 11, 2019 at 11:16 PM
...
INSERT INTO `tb_cities` (`woeid_city`, `name`, `latitude`, `longitude`, `country`, `population`, `currency`, `province`, `area`, `time_zone`, `website`) VALUES
...
INSERT INTO `tb_photos` (`photo_id`, `link`, `woeid_city`, `woeid_poi`, `name`) VALUES
...
(24, 'https://goo.gl/3AKwtw', 25211, 23702074, 'University of Hull'),
...
(42, 'https://euromast.nl/wp-content/uploads/2017/04/AGM_7464.jpg', 733075, 729194, 'Euromast'),
(43, 'https://euromast.nl/wp-content/uploads/2017/04/Brasserie-kopie.jpg', 733075, 729194, 'Euromast'),
(44, 'https://www.cityguiderotterdam.com/fileadmin/_processed_/6/9/csm_Euromast_Rotterdam_watertaxi_slider_1dd832c21d.jpg', 733075, 729194, 'Euromast'),
(45, 'https://c1.staticflickr.com/5/4479/36610949663_af1215ee41_b.jpg', 733075, 729194, 'Euromast'),
...
(50, 'https://www.mediastorehouse.com/p/251/rotterdam-erasmus-bridge-euromast-tower-1655853.jpg', 733075, 91412178, 'Erasmus Bridge');
...
--
-- Dumping data for table `tb_pois`
--

INSERT INTO `tb_pois` (`woeid_poi`, `latitude`, `longitude`, `name`, `capacity`, `cost`, `launch`, `website`, `opening_time`, `closing_time`, `woeid_city`) VALUES
...
(730730, 51.884508, 4.632675, 'Kinderdijk', NULL, 8, '1740-01-01', 'https://www.kinderdijk.com', NULL, NULL, 733075),
...
(56816533, 53.744428, -0.337735, 'Hull City Centre', NULL, 0, '1193-01-01', 'https://www.visithullandeastyorkshire.com/', NULL, NULL, 25211),
...
(91412178, 51.90903, 4.487123, 'Erasmus Bridge', NULL, 0, '1996-01-01', 'https://en.wikipedia.org/wiki/Erasmusbrug', NULL, NULL, 733075),
...
--
-- Constraints for table `tb_cities`
--
ALTER TABLE `tb_cities`
  ADD CONSTRAINT `tb_city_tb_photo_woeid_city_fk` FOREIGN KEY (`woeid_city`) REFERENCES `tb_photos` (`woeid_city`),
  ADD CONSTRAINT `tb_city_tb_poi_woeid_city_fk` FOREIGN KEY (`woeid_city`) REFERENCES `tb_pois` (`woeid_city`);

--
-- Constraints for table `tb_pois`
--
ALTER TABLE `tb_pois`
  ADD CONSTRAINT `tb_poi_tb_photo_woeid_poi_fk` FOREIGN KEY (`woeid_poi`) REFERENCES `tb_photos` (`woeid_poi`);
COMMIT;
